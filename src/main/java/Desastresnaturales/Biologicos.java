...
public class Biologicos extends Desastres{
    private int personasAfectadas;
    private int impactoEconomico;
    private int númeroDesastres;

    public Biologicos(String nombre, String lugar, String fecha, int personasAfectadas, int impactoEconomico, int númeroDesastres) {
